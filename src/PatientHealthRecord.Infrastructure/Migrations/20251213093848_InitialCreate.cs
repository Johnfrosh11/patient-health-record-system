        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthRecords_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessStartDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AccessEndDateTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessRequests_HealthRecords_HealthRecordId",
                        column: x => x.HealthRecordId,
                        principalTable: "HealthRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessRequests_Users_RequestingUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_HealthRecordId",
                table: "AccessRequests",
                column: "HealthRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessRequests_RequestingUserId",
                table: "AccessRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthRecords_CreatedBy",
                table: "HealthRecords",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_HealthRecords_IsDeleted",
                table: "HealthRecords",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_HealthRecords_PatientName",
                table: "HealthRecords",
                column: "PatientName");
